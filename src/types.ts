...
export type PublicSubscription =
  ...
  | PublicOrderbooksSubscription
  | PublicTradesSubscription;
...
export type PrivateSubscription =
  | PrivateExecutionEventsSubscription
  | PrivateOrderEventsSubscription
  | PrivatePositionEventsSubscription
